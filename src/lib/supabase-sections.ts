...
export async function createSection(
  data: Omit<Section, 'id' | 'created_at'>
): Promise<string> {
  ...
  const defaults: { name: string; type: SectionType; description: string }[] = [
    {
      name: 'Homepage',
      type: 'homepage',
      description: 'Featured products on the homepage',
    },
    {
      name: 'Featured',
      type: 'featured',
      description: 'Highlighted products across the site',
    },
    {
      name: 'Promotions',
      type: 'promotions',
      description: 'Products on sale and promotions',
    },
    {
      name: 'Categories',
      type: 'category',
      description: 'Products organized by category',
    },
  ];
