  ...
  return (
    <aside className="flex flex-col w-64 border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-950">
      ...
      <div className="border-t border-gray-200 p-4 dark:border-gray-800">
        ...
        }} className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950">
